...
Carpeta en un proyecto de lama o instantánea yang tidak lagi aktif.

Aturan:

- subcarpeta gunakan por tahun, misalnya `archive/2026/`
- anggap isi archive bersifat lectura mayoritaria
- proyecto jangan pindahkan aktif ke sini kecuali memang sudah retirado atau reemplazado