...
Folder iniți adalah rumah untuk aplicație pentru proiectul yang masih aktif.

Subfolder Gunakan berdasarkan platform utama:

- `web/` untuk app web
- `mobile/` pentru aplicația mobilă

Jangan taruh benchmark agent atau research archive di sini.