...
Der Ordner wird für Benchmark-, Evaluierungs- und Workflow-Tests verwendet, die von der Projektaktivität ausgehen.

## Saran Struktur

- satu eksperimen satu Ordner
- simpan `README.md` mit Befehl, Befehlsausführung, erwartetes Ergebnis, und beobachtetes Ergebnis
- Kann `.env.example` als Umgebungsvariable verwenden