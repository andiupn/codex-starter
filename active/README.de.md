...
Der Ordner ist für die Anwendung auf dem Projekt gedacht, das viele Aktionen ausführt.

Der Gunakan-Unterordner enthält Plattforminhalte:

- `web/` für die Web-App
- `mobile/` für die mobile App

Jangan Taruh Benchmark Agent in unserem Forschungsarchiv.