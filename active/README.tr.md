...
Projede aktif olarak yer alan uygulamalar için klasör başlatıldı.

Gunakan alt klasörü, platformun oluşturulmasını sağlar:

- Web uygulamasına `web/`
- Mobil uygulama için `mobile/`

Benchmark Agent'ı ve araştırma arşivini araştırdım.