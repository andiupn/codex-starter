...
Carpeta de tránsito para el proyecto y el material yang belum rapi.

Gunakan `staging/` para:

- hasil importar awal
- proyecto yang masih dipilah
- borrador migrasi sebelum dipindah ke `active/` atau `archive/`

Proyecto Jangan biarkan matang tinggal terlalu lama di sini.