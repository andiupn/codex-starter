...
Folder transit untuk proyek atau material yang belum rapi.

Gunakan `staging/` untuk:

- hasil import awal
- proyek yang masih dipilah
- draft migrasi sebelum dipindahkan ke `active/` atau `archive/`

Jangan biarkan proyek matang tinggal terlalu lama di sini.