...
Le dossier initial est destiné à l'application du projet yang masih actif.

Sous-dossier Gunakan plate-forme berdasarkan utama :

- `web/` pour l'application Web
- `mobile/` pour l'application mobile

Je cherche un agent de référence dans les archives de recherche d'ici.