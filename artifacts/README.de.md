...
Der Ordner wird für die von der App/dem Projekt generierte Ausgabe erstellt.

Contoh:

- Screenshot-Benutzeroberfläche
- Exportierter Bericht
- Ausgabe zur Überprüfung des Handbuchs erfasst

Um den Benchmark-Agenten in den Ordner `experiments/` senden zu können, müssen Sie die Ausgabe des Benchmarks in den Ordner „Experimen“ übertragen.