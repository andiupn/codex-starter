...
Pasta ini para hal-hal reutilizável lintas projeto ativo.

Use `shared/` para:

- bens comuns
- snippet de configuração reutilizável
- ajudante kecil yang tidak layak menjadi projeto sendiri

Se o seu ciclo de vida punya for enviado ao aplicativo, taruh di `active/`, bukan di sini.