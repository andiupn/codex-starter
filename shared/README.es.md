...
Carpeta ini untuk hal-hal reutilizable lintas proyecto activo.

Gunakan `shared/` para:

- bienes comunes
- fragmento de configuración reutilizable
- ayudante kecil yang tidak layak menjadi proyecto sendiri

Jika sesuatu punya ciclo de vida aplicación sendiri sebagai, taruh di `active/`, bukan di sini.