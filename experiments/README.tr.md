...
Aktif olarak projenin değerlendirilmesi, değerlendirilmesi ve iş akışı testi için klasör açılır.

## Saran Yapı

- satu eksperimen satu klasörü
- komut çalıştırma, beklenen sonuç ve gözlemlenen sonucun aynısını `README.md` yapın
- gunakan `.env.example` bila eksperimen butuh ortam değişkeni