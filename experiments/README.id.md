...
Folder ini dipakai untuk benchmark, eval, dan workflow test yang terpisah dari proyek aktif.

## Saran Struktur

- satu eksperimen satu folder
- simpan `README.md` dengan tujuan, perintah dijalankan, hasil yang diharapkan, dan hasil yang diamati
- gunakan `.env.example` bila eksperimen membutuhkan variabel lingkungan