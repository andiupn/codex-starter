...
Бесплатное приложение для мобильных устройств, активирующее папку INI.

Цель Конто:

- Приложение Flutter
- Приложение React Native.
- мобильный прототип Ян Биса Диджаланкан

Папка формата Гунакан:

`active/mobile/<app-name>/`