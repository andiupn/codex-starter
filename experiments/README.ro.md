...
Folderul este un benchmark, eval și testul fluxului de lucru, iar proiectul este activ.

## Saran Struktur

- satu experimente satu folder
- simpan `README.md` dengan tujuan, comanda rulare, rezultatul așteptat, rezultatul observat
- gunakan `.env.example` bila experiemen butuh mediu variabilă