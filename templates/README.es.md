...
Carpeta ini para un proyecto inicial y reutilizable.

Gunakan `templates/` para:

- aplicación esqueleto baru
- pila repetitiva tertentu
- arrancador yang sengaja dibuat untuk disalin ke `active/`

Isi plantilla harus seumum mungkin dan tidak mengandung data runtime proyecto activo.