...
Ordner für das wiederverwendbare Starterprojekt.

Gunakan `templates/` für:

- Skelett-App-Baru
- Boilerplate-Stack tertentu
- Der Starter wurde zur Disposition von `active/` aufgefordert.

Die ISI-Vorlage dient dazu, Daten zur Laufzeit des Projekts zu aktualisieren.