...
Mapp transit untuk projekt atau material yang belum rapi.

Gunakan `staging/` till:

- hasil import awal
- projekt yang masih dipilah
- draft migrasi sebelum dipindah ke `active/` atau `archive/`

Jangan biarkan projekt matang tinggal terlalu lama di sini.