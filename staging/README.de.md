...
Der Ordner „Transit“ für das Projekt enthält wertvolle Materialien.

Gunakan `staging/` für:

- hasil import awal
- Projekt Yang Masih Dipilah
- Draft-Migrasi-Sebelum-Dipindah-Ke `active/` oder `archive/`

Das erste Projekt, bei dem die meisten Menschen aufgewachsen sind.