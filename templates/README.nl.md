...
Mappen voor startersprojecten zijn herbruikbaar.

Gunakan `templates/` voor:

- skelet-app baru
- boilerplate-stack tertentu
- starter gaat naar het einde van `active/`

Deze sjabloon bevat meer informatie over het actieve dataruntime-project.