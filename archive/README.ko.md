...
폴더는 프로젝트 lama atau snapshot yang tidak lagi aktif의 ini입니다.

아투란:

- tahun당 gunakan 하위 폴더, misalnya `archive/2026/`
- 앙갑 isi 아카이브 베르시파트 읽기-대부분
- jangan pindahkan 프로젝트 aktif ke sini kecuali memang sudah 은퇴 atau 대체