...
Cartella iniziale per il progetto iniziale yang riutilizzabile.

Usa `templates/` per:

- barra dell'app scheletro
- tertentu camino caldaia
- antipasto yang sengaja dibuat per disalin ke `active/`

Il modello Isi ha tutte le sue potenzialità e non è in grado di gestire i dati del progetto runtime attivo.