...
Папка ini представляет собой приложение для проекта, который может быть активным.

Подпапка Гунакан Бердасаркан Платформа Утама:

- `web/` для веб-приложения
- `mobile/` для мобильного приложения

Джанган Тарух эталонный агент Атау исследовательский архив в Сини.