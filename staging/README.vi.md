...
Thư mục quá cảnh cho dự án atau chất liệu yang belum rapi.

Gunakan `staging/` cho đến:

- awal nhập khẩu hasil
- dự án yang masih dipilah
- dự thảo di chuyển dipindah ke `active/` atau `archive/`

Dự án có thể được thực hiện sẽ giúp bạn thực hiện được điều đó.