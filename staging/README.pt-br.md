...
Trânsito de pasta para projeto ou material yang belum rapi.

Use `staging/` para:

- hasil importação awal
- projeto yang masih dipilah
- draft migrasi sebelum dipindah ke `active/` ou `archive/`
