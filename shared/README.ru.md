...
Папка ini для многоразового использования проекта lintas aktif.

Гунакан `shared/` для:

- общие активы
- многоразовый фрагмент конфигурации
- помощник Кесил Ян Тидак Лайак Менджади проект Сендири

Вы можете использовать жизненный цикл приложения, используя `active/`, и используя его.