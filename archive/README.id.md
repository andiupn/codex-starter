...
Folder ini untuk proyek lama atau snapshot yang tidak lagi aktif.

Aturan:

- gunakan subfolder per tahun, misalnya `archive/2026/`
- Menganggap isi arsip bersifat read-mostly
- jangan pindahkan proyek aktif ke sini kecuali memang sudah pensiun atau digantikan