...
Folderul este reutilizabil pentru proiectul de pornire.

Gunakan `templates/` untuk:

- aplicația schelet baru
- boilerplate stack tertentu
- starter yang sengaja dibuat untuk disalin ke `active/`

Șablonul Isi are un proiect de funcționare și un proiect de rulare a datelor.