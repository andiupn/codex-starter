...
Folder ini untuk projektu lama atau snapshot yang tidak lagi aktif.

Aturan:

- podfolder gunakan dla tahun, misalnya `archive/2026/`
- archiwum ISI anggap jest przeznaczone głównie do odczytu
- Jangan pindahkan projekt aktif ke sini kecuali memang sudah emerytowany atau zastąpiony