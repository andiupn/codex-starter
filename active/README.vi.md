...
Thư mục này sẽ giúp bạn ứng dụng vào dự án mà bạn có thể thực hiện.

Thư mục con Gunakan nền tảng berdasarkan utama:

- `web/` cho web ứng dụng
- `mobile/` cho ứng dụng di động

Jangan taruh điểm chuẩn đại lý tại kho lưu trữ nghiên cứu của sini.