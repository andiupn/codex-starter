...
Используйте веб-приложение, активирующее папку ini.

Цель Конто:

- Приложение Next.js
- Веб-приложение PHP
- приборная панель внутренняя
- API-шлюз для администратора пользовательского интерфейса.
