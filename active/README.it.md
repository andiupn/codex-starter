...
La cartella è questa cartella per l'applicazione o il progetto yang masih aktif.

Sottocartella Gunakan piattaforma berdasarkan utama:

- `web/` per accedere all'app Web
- `mobile/` per accedere all'app mobile

Jangan Taruh agente di riferimento atau Research Archive di Sini.