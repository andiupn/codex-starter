...
Ця папка призначена для створення знімка проекту або моментального знімка, який не активований.

Атуран:

- підпапка gunakan per tahun, misalnya `archive/2026/`
- anggap isi archive bersifat read-mostly
- jangan pindahkan project actif ke sini kecuali memang sudah пішов у відставку або замінено