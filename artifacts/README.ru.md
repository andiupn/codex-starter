...
Папка ini для вывода, созданного в приложении/проекте.

Конто:

- скриншот пользовательского интерфейса
- экспортированный отчет
- захваченный результат для ознакомления с руководством

Чтобы использовать агент эталонного тестирования и отправить папку `experiments/`, просто выведите выходные тестовые данные из папки для экспериментов.