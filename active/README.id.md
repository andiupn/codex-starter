...
Folder ini adalah rumah untuk aplikasi atau proyek yang masih aktif.

Gunakan subfolder berdasarkan platform utama:

- `web/` untuk web aplikasi
- `mobile/` untuk aplikasi seluler

Jangan taruh agen benchmark atau arsip penelitian di sini.