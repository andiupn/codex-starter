...
フォルダーは、プロジェクトのラマ アタウ スナップショット、ヤン ティダク ラギ アクティフを保存します。

アトゥラン：

- tahun、misalnya `archive/2026/` ごとの gunakan サブフォルダー
- anggap isi アーカイブ bersifat read-mostly
- ジャンガン・ピンダカン・プロジェクト・アクティフ・ケ・シニ・ケクアリ・メマン・スダが引退、アタウに取って代わられる