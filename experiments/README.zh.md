...
文件夹 ini dipakai untuk benchmark、eval、dan 工作流程测试 yang terpisah dari 项目 aktif。

## 萨兰结构

- satu eksperimen satu 文件夹
- simpan `README.md` dengan tujuan，命令运行，预期结果，但观察到的结果
-gunakan `.env.example` bila eksperimen butuh 环境变量