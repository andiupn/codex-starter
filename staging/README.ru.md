...
Папка транзита для проекта с материалами ян белум рапи.

Гунакан `staging/` для:

- хасил импорт аваль
- проект Ян Масих Дипила
- проект migrasi sebelum dipindah ke `active/` atau `archive/`

Проект Jangan biarkan matang tinggal terlalu lama di sini.