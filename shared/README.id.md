...
Folder ini untuk hal-hal dapat digunakan kembali sepanjang proyek aktif.

Gunakan `shared/` untuk:

- aset bersama
- cuplikan konfigurasi yang dapat digunakan kembali
- Helper kecil yang tidak layak menjadi proyek sendiri

Jika sesuatu punya siklus hidup sendiri sebagai aplikasi, taruh di `active/`, bukan di sini.