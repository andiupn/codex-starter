...
Esta pasta é reutilizável para o projeto inicial.

Use `templates/` para:

- aplicativo de esqueleto baru
- pilha padrão tertentu
- starter yang sengaja dibuat untuk disalin ke `active/`

Este modelo é muito importante e não permite a implementação do projeto de tempo de execução de dados.