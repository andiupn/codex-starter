...
フォルダー ini dipakai untuk ベンチマーク、eval、ワークフロー テスト ヤン テルピサ ダリ プロジェクト aktif。

## サラン・ストラクトゥル

- サトゥエクスペリメンサトゥフォルダ
- simpan `README.md` dengan tujuan、コマンド実行、期待される結果、観察された結果
- gunakan `.env.example` 環境変数を参照してください