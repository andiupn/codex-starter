...
La cartella è stata inserita per il benchmark, la valutazione e il test del flusso di lavoro che hai ottenuto dal progetto attivo.

## Saran Struktur

- cartella satu eksperimen satu
- simpan `README.md` con l'esecuzione del comando, il risultato atteso e il risultato osservato
- usa `.env.example` bila eksperimen mauh variabile d'ambiente