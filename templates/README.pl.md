...
Folder ini untuk startowy projekt yang wielokrotnego użytku.

Gunakan `templates/` dla:

- szkielet aplikacji baru
- tertentu stosu szablonów
- starter yang sengaja dibuat untuk disalin ke `active/`

Szablon Isi harus seumum mungkin dan tidak mengandung aktif projektu środowiska wykonawczego danych.