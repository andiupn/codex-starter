...
Mapp ini dipakai untuk benchmark, eval, och workflow test yang terpisah dari project aktif.

## Saran Struktur

- satu eksperimen satu mapp
- Simpan `README.md` dengan tujuan, kommandokörning, förväntat resultat, och observerat resultat
- Gunakan `.env.example` bila experiment butuh miljövariabel