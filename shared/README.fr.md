...
Dossier initial pour l'activité du projet de lintas réutilisable hal-hal.

Gunakan `shared/` pour :

- les biens communs
- extrait de configuration réutilisable
- assistant kecil yang tidak layak menjadi projet sendiri

Jika sesuatu punya lifecycle sendiri sebagai app, lancé par `active/`, ici.