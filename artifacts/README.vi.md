...
Thư mục này cho đến đầu ra được tạo ra từ ứng dụng/dự án đó.

Contoh:

- giao diện người dùng ảnh chụp màn hình
- báo cáo đã xuất
- đầu ra được ghi lại cho đến khi xem xét hướng dẫn sử dụng

Untuk benchmark Agent yang sudah punya folder sendiri di `experiments/`, tetap simpan đầu ra benchmark di folder eksperimen terkait.