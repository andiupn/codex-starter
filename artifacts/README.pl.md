...
Folder ini untuk wygenerował aplikację/projekt dari pekerjaan.

Contoh:

- interfejs zrzutu ekranu
- wyeksportowany raport
- przechwycone dane wyjściowe do podręcznika przeglądu

Dla agenta porównawczego yang sudah punya folder sendiri di `experiments/`, tetap simpan wyjściowy test porównawczy w folderze testowym terkait.