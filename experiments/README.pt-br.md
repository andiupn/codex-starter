...
A pasta é usada para benchmark, avaliação e teste de fluxo de trabalho que é a base do projeto ativo.

## Saran Estrutura

- pasta satu eksperimen satu
- simpan `README.md` com tujuan, execução de comando, resultado esperado e resultado observado
- usar `.env.example` é uma variável de ambiente diferente