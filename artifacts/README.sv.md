...
Mapp ini untuk output genererad dari pekerjaan app/projekt.

Contoh:

- skärmdump UI
- exporterad rapport
- fångad utdata untuk granskning manual

Untuk benchmark agent yang sudah punya mapp sendiri di `experiments/`, tetap simpan output benchmark di mapp experimen terkait.