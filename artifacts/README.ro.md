...
Folderul a fost generat de ieșirea din aplicația/proiectul.

Contoh:

- captură de ecran UI
- raport exportat
- ieșire capturată untuk review manual

Agentul de referință a fost trimis în dosarul `experiments/`, apoi va apărea un benchmark de ieșire din dosarul de experiență.