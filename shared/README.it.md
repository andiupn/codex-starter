...
Cartella iniziale per hal-hal riutilizzabile lintas project aktif.

Usa `shared/` per:

- beni comuni
- Snippet di configurazione riutilizzabile
- aiutante kecil yang tidak layak menjadi progetto sendiri
