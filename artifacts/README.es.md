...
Carpeta de inicio para la salida generada por la aplicación/proyecto.

Contoh:

- interfaz de usuario de captura de pantalla
- informe exportado
- salida capturada para el manual de revisión

Para el agente de referencia y la carpeta de destino de `experiments/`, toque simplemente la salida de la carpeta de experimentos externos.