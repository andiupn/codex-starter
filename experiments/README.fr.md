...
Le dossier initial contient des références, des évaluations et des tests de flux de travail pour l'activité du projet.

## Saran Structure

- dossier satu eksperimen satu
- simpan `README.md` avec tujuan, exécution de commande, résultat attendu, et résultat observé
- utiliser `.env.example` pour expérimenter une variable d'environnement