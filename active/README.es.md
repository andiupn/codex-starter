...
Carpeta ini adalah rumah untuk aplikasi atau project yang masih aktif.

Subcarpeta Gunakan plataforma berdasarkan utama:

- `web/` para la aplicación web
- `mobile/` para la aplicación móvil

Jangan taruh agente de referencia en el archivo de investigación de sini.