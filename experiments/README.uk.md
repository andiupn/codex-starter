...
Ця папка доступна для тестування бенчмарка, оцінки та тестування робочого циклу, щоб виконати активний проект.

## Saran Struktur

- папка satu eksperimen satu
- simpan `README.md` dengan tujuan, командний запуск, очікуваний результат, і спостережуваний результат
- gunakan `.env.example` була експериментальною змінною середовища