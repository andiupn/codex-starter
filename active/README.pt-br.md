...
A pasta é um espaço para um aplicativo ou projeto mais ativo.

Subpasta Gunakan berdasarkan platform utama:

- `web/` para aplicativo web
- `mobile/` para aplicativo móvel

Jangan taruh agente de referência ou arquivo de pesquisa em si.