...
Folder ini adalah rumah untuk aplikasi atau projektu yang masih aktif.

Podfolder Gunakan platforma berdasarkan utama:

- `web/` w aplikacji internetowej
- `mobile/` w aplikacji mobilnej

Jangan Taruh agent wzorcowy w archiwum badawczym sini.