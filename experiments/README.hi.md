...
बेंचमार्क, ईवल, और वर्कफ़्लो टेस्ट या प्रोजेक्ट एक्टिफ़ के लिए इस फ़ोल्डर का उपयोग करें।

## सारण संरचना

- सतु एक्सपेरिमेन सतु फ़ोल्डर
- सिम्पन `README.md` टुजुआन, कमांड रन, अपेक्षित परिणाम, और अवलोकन किया गया परिणाम
- गुनाकन `.env.example` एक उदाहरण के रूप में पर्यावरण चर