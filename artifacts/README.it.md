...
Cartella iniziale per l'output generato dall'app/progetto pekerjaan.

Conto:

- schermata dell'interfaccia utente
- rapporto esportato
- output catturato per il manuale di revisione

Per far sì che l'agente benchmark non invii la cartella in `experiments/`, prova a riprodurre il benchmark dell'output della cartella eksperimen.