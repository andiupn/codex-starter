...
Folder ini dipakai untuk benchmark, eval, dan test przepływu pracy yang terpisah dari projekt aktif.

## Saran Struktur

- folder satu eksperimen satu
- simpan `README.md` dengan tujuan, wykonanie polecenia, oczekiwany wynik, dan zaobserwowany wynik
- gunakan `.env.example` bila eksperimen butuh zmienna środowiskowa