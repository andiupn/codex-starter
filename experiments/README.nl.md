...
De map wordt geopend voor benchmark, evaluatie en workflowtest om het project te activeren.

## Saran Struktur

- satu exsperimen satu-map
- vereenvoudig `README.md` met de opdrachtuitvoering, het verwachte resultaat en het waargenomen resultaat
- gunakan `.env.example` bila exsperimen butuh omgevingsvariabele