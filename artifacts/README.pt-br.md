...
Esta pasta é gerada para a saída gerada pelo aplicativo/projeto.

Conto:

- captura de tela da interface do usuário
- relatório exportado
- saída capturada para manual de revisão

Para que o agente de benchmark seja enviado para a pasta `experiments/`, basta selecionar o benchmark de saída da pasta experimental.