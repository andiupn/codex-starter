...
A pasta é para o projeto, seja um instantâneo ou um instantâneo que não esteja ativo.

Aturano:

- subpasta gunakan para tahun, misalnya `archive/2026/`
- arquivo anggap isi bersifat principalmente para leitura
- projeto jangan pindahkan ativo ke sini kecuali memang sudah aposentado ou substituído