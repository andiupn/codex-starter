...
Folder ini untuk proyek awal yang dapat digunakan kembali.

Gunakan `templates/` untuk:

- aplikasi kerangka baru
- tumpukan boilerplate tertentu
- starter yang sengaja dibuat untuk pendingin ke `active/`

Isi template harus seumum mungkin dan tidak mengandung data runtime project aktif.