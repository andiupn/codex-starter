...
Dossier ini pour le projet de démarrage yang réutilisable.

Gunakan `templates/` pour :

- application squelette baru
- tertentu de pile passe-partout
- starter yang sengaja dibuat pour disalin ke `active/`

Le modèle ISI vous permet de gérer et d'activer le projet d'exécution de données.