...
Map wordt geopend voor uitvoer gegenereerd door app/project.

Contoh:

- screenshot-gebruikersinterface
- geëxporteerd rapport
- vastgelegde uitvoer voor de beoordelingshandleiding

Als de benchmarkagent de map naar `experiments/` stuurt, tikt u op eenvoudige uitvoerbenchmark naar de map experimen terkait.