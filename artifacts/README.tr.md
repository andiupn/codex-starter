...
Uygulama/proje tarafından oluşturulan çıktının bulunduğu klasör.

Contoh:

- ekran görüntüsü kullanıcı arayüzü
- dışa aktarılan rapor
- kılavuzun incelenmesi için yakalanan çıktı

`experiments/` klasörünü gönderen kıyaslama aracısı için, ek deney klasörünün çıktı karşılaştırmasını yapın.