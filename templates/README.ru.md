...
Папка ini для стартового проекта многоразового использования.

Гунакан `templates/` для:

- скелет приложения бару
- стандартный стек тертенту
- стартер может изменить ситуацию, чтобы отключить его `active/`

Шаблон Isi harus seumum mungkin dan tidak mengandung data runtime project aktif.