...
Cartella iniziale per il progetto lama atau snapshot yang tidak lagi aktif.

Aturan:

- sottocartella gunakan per tahun, misalnya `archive/2026/`
- archivio anggap isi bersifat in gran parte in lettura
- jangan pindahkan progetto aktif ke sini kecuali memang sudah ritirato atau sostituito