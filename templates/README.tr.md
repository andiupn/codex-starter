...
Yeniden kullanılabilir başlangıç projesi için klasör.

Şunun için `templates/`:

- iskelet uygulaması baru
- standart yığın tertentu
- `active/`'yi devre dışı bırakmak için başlatıcıyı etkinleştirin

Isi şablonu harus seumum mungkin ve tidak mengandung veri çalışma zamanı projesi aktif.