...
Yeniden kullanılabilir proje için aktif olan klasör.

Şunun için `shared/`:

- ortak varlıklar
- yeniden kullanılabilir yapılandırma pasajı
- yardımcı kecil yang tidak menjadi proje sendiri

Bir yaşam döngüsü uygulaması, `active/` ile bir uygulamadır ve bu da bunu sağlar.