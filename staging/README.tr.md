...
Proje ve malzemeyle ilgili klasör geçişi.

Şunun için `staging/`:

- hasil ithalat awal
- yang masih dipilah projesi
- `active/` veya `archive/` ile ilgili taslak geçiş taslağı

Bir proje daha var, bu da bir lama di sini.