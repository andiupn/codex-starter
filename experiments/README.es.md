...
Carpeta que se abre para pruebas comparativas, evaluaciones y pruebas de flujo de trabajo que se encuentran activas en el proyecto.

## Saran Estructura

- carpeta satu eksperimen satu
- simpan `README.md` con tujuan, ejecución del comando, resultado esperado, resultado observado
- gunakan `.env.example` bila eksperimen butuh variable de entorno