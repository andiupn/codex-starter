...
Ordner ini für hal-hal wiederverwendbare Lintas-Projektaktif.

Gunakan `shared/` für:

- Gemeinschaftsvermögen
- wiederverwendbares Konfigurations-Snippet
- Helfer Kecil Yang Tidak Layak Menjadi Projekt Sendiri

Sie können den Lebenszyklus der App mit `active/` und anderen teilen.