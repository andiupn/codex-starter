...
Папка ini для активації проекту hal-hal багаторазового використання.

Гунакан `shared/` для:

- спільні активи
- багаторазовий фрагмент конфігурації
- помічник kecil yang tidak layak menjadi project sendiri

Jika sesuatu punya lifecycle sendiri sebagai app, taruh di `active/`, bookan di sini.