...
Map starten voor een herbruikbaar lintasproject actief.

Gunakan `shared/` voor:

- gemeenschappelijke bezittingen
- herbruikbaar configuratiefragment
- helper Kecil Yang Tidak Layak Menjadi Project Sendiri

Als u de levenscyclus van een app verzendt, kunt u `active/` gebruiken als u dit wilt.