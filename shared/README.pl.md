...
Folder ini untuk hal-hal wielokrotnego użytku Lintas Project Aktif.

Gunakan `shared/` dla:

- majątek wspólny
- fragment konfiguracji wielokrotnego użytku
- pomocnik Kecil Yang Tidak Layak Menjadi Project Sendiri

Jika sesuatu punya lifecycle sendiri sebagai aplikacja, taruh di `active/`, bukan di sini.