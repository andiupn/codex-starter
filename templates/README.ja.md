...
フォルダー ini untuk スターター プロジェクト yang は再利用可能です。

グナカン `templates/` ウントゥク:

- スケルトンアプリバル
- 定型スタック tertentu
- スターター ヤン センガジャ ディブアット ウントゥク ディサリン ケ `active/`

ISI テンプレート ハルス セウム ムンキン ダン ティダク メンガンドゥン データ ランタイム プロジェクト aktif。