...
Dossier initial pour la sortie générée par l'application/le projet.

Contoh :

- interface utilisateur de capture d'écran
- rapport exporté
- sortie capturée pour le manuel de révision

Pour que l'agent de référence yang sudah punya dossier envoie vers `experiments/`, vous devez simplement sortie de référence dans le dossier d'expériences terminées.