...
Це папка, щоб створити програму або активний проект.

Підпапка Gunakan berdasarkan platform utama:

- `web/` для веб-програми
- `mobile/` для мобільної програми

Додатковий агент порівняльного аналізу або архів досліджень.