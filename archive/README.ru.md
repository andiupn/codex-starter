...
Папка ini для моментального снимка проекта lama atau yang tidak lagi aktif.

Атуран:

- подпапка Gunakan для тахуна, мисальная `archive/2026/`
- anggap isi архив bersifat читается в основном
- Проект Джанган Пиндахкан активен ке Сини Кекуали Меманг Судах в отставке Атау заменен