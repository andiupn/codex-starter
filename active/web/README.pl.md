...
Taruh aplikasi web aktif di folder ini.

Cel Contoha:

- Aplikacja Next.js
- Aplikacja internetowa PHP
- deska rozdzielcza wewnętrzna
- Brama API z administratorem interfejsu użytkownika

Folder w formacie Gunakan:
