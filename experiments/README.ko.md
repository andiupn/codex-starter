...
벤치마크, 평가, 워크플로 테스트를 위한 폴더 초기화는 프로젝트 aktif와 같습니다.

## 사란 스트럭터

- satu eksperimen satu 폴더
- simpan `README.md` dengan tujuan, 명령 실행, 예상 결과, 관찰된 결과
- gunakan `.env.example` bila eksperimen butuh 환경 변수