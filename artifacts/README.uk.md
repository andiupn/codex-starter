...
Папка ini для виводу, згенерованого для програми/проекту.

Contoh:

- скріншот інтерфейсу
- експортований звіт
- отримані результати для перегляду посібника

Для того, щоб агент порівняльного тесту отримав повну папку, яка відправляється в папку `experiments/`, натисніть простий вихідний тест тесту в папці експерименту.