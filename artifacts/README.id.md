...
Folder ini untuk keluaran yang dihasilkan dari aplikasi/proyek pekerjaan.

Contoh:

- tangkapan layar UI
- laporan yang diekspor
- keluaran yang diambil untuk meninjau manual

Untuk agen benchmark yang sudah punya folder sendiri di `experiments/`, tetap menyimpan output benchmark di folder eksperimen terkait.