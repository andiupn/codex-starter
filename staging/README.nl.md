...
Folder doorvoer voor projectmateriaal dat niet goed is.

Gunakan `staging/` voor:

- hasil import awal
- project yang masih dipilah
- draft migrasi sebelum dipindah ke `active/` atau `archive/`

Jangan biarkan project gaat over de lange termijn van zijn leven.