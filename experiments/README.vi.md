...
Thư mục này cung cấp cho bạn điểm chuẩn, đánh giá và kiểm tra quy trình làm việc của dự án.

## Saran Struktur

- satu eksperimen satu thư mục
- simpan `README.md` dengan tujuan, lệnh chạy, kết quả mong đợi, kết quả được quan sát
- gunakan `.env.example` bila eksperimen butuh biến môi trường