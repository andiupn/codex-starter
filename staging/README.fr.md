...
Dossier de transit pour le projet et le matériel yang belum rapi.

Gunakan `staging/` pour :

- hasil import awal
- projet yang masih dipilah
- projet de migration sebelum dipindah ke `active/` atau `archive/`

Projet Jangan Biarkan Matang Tinggal Terlalu Lama di Sini.